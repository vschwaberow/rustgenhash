...
pub fn run_benchmarks(algorithms: &[Algorithm], iterations: u32) {
    ...
    for alg in algorithms {
        let duration = match alg {
            ...
            Algorithm::Gost94ua => benchmark_rhash("GOST94UA", iterations),
            Algorithm::Argon2 => benchmark_phash(
                |password| PHash::hash_argon2(password, &argon2_config),
                iterations,
            ),
            ...
            Algorithm::Ripemd160 => benchmark_rhash("RIPEMD160", iterations),
            Algorithm::Sha1 => benchmark_rhash("SHA1", iterations),
            Algorithm::Sha3_224 => benchmark_rhash("SHA3_224", iterations),
            Algorithm::Sha3_256 => benchmark_rhash("SHA3_256", iterations),
            Algorithm::Sha3_384 => benchmark_rhash("SHA3_384", iterations),
            Algorithm::Sha3_512 => benchmark_rhash("SHA3_512", iterations),
            Algorithm::Shabal192 => benchmark_rhash("SHABAL192", iterations),
            Algorithm::Shabal224 => benchmark_rhash("SHABAL224", iterations),
            Algorithm::Shabal256 => benchmark_rhash("SHABAL256", iterations),
            Algorithm::Shabal384 => benchmark_rhash("SHABAL384", iterations),
            Algorithm::Shabal512 => benchmark_rhash("SHABAL512", iterations),
            Algorithm::Skein256 => benchmark_rhash("SKEIN256", iterations),
            Algorithm::Skein512 => benchmark_rhash("SKEIN512", iterations),
            Algorithm::Skein1024 => benchmark_rhash("SKEIN1024", iterations),
            Algorithm::Sm3 => benchmark_rhash("SM3", iterations),
            Algorithm::Streebog256 => benchmark_rhash("STREEBOG256", iterations),
            Algorithm::Streebog512 => benchmark_rhash("STREEBOG512", iterations),
            Algorithm::Tiger => benchmark_rhash("TIGER", iterations),
            Algorithm::Whirlpool => benchmark_rhash("WHIRLPOOL", iterations),
            Algorithm::Balloon => benchmark_phash(
                |password| PHash::hash_balloon(password, &balloon_config),
                iterations,
            ),
            Algorithm::Bcrypt => benchmark_phash(
                |password| PHash::hash_bcrypt(password, &bcrypt_config),
                iterations,
            ),
            ...
            Algorithm::Scrypt => benchmark_phash(
                |password| PHash::hash_scrypt(password, &scrypt_config),
                iterations,
            ),
            Algorithm::Pbkdf2Sha256 => benchmark_phash(
                |password| PHash::hash_pbkdf2(password, "pbkdf2sha256", &pbkdf2_config),
                iterations,
            ),
            Algorithm::Pbkdf2Sha512 => benchmark_phash(
                |password| PHash::hash_pbkdf2(password, "pbkdf2sha512", &pbkdf2_config),
                iterations,
            ),
            _ => {
